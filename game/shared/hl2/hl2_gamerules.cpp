...
//riotgun
ConVar	sk_plr_dmg_riotgun("sk_plr_dmg_riotgun", "0", FCVAR_REPLICATED);
ConVar	sk_npc_dmg_riotgun("sk_npc_dmg_riotgun", "0", FCVAR_REPLICATED);
ConVar	sk_max_riotgun("sk_max_riotgun", "0", FCVAR_REPLICATED);

...
//
#define ZOMBIE_THROW_FIRST_MIN_DELAY	9999999	// min seconds before first crab throw
#define ZOMBIE_THROW_FIRST_MAX_DELAY	9999999	// max seconds before first crab throw

//
// Controls how often he throws headcrabs (also how often headcrabs leap off)
//
#define ZOMBIE_THROW_MIN_DELAY	9999999		// min seconds between crab throws
#define ZOMBIE_THROW_MAX_DELAY	9999999		// max seconds between crab throws
...
#define ZOMBIE_ENEMY_BREATHE_DIST		100	// How close we must be to our enemy before we start breathing hard.
...
void CNPC_PoisonZombie::BuildScheduleTestBits(void)
{
	...
	else if (IsCurSchedule(SCHED_CHASE_ENEMY) || IsCurSchedule(SCHED_CHASE_ENEMY))
	{
